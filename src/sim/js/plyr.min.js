...
(this, (function() {
	...
	var a= {
		addCSS:  !0, thumbWidth:15, watch: !0
	}
	...
	var T=function() {
		function e(t, i) {
			...
			)(this, e), b(t)?this.element=t:p(t)&&(this.element=document.querySelector(t)), b(this.element)&&v(this.element.rangeTouch)&&(this.config=n( {}
